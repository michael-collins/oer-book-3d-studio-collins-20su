...
output += "\" href=\"";
output += runtime.suppressValue(env.getFilter("url").call(context, runtime.memberLookup((runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "metadata")),"feed")),"path")), env.opts.autoescape);
output += "\" />\n  <link rel=\"icon\" href=\"";
output += runtime.suppressValue(env.getFilter("url").call(context, runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "site")),"faviconPath")), env.opts.autoescape);
...
tasks.push(
function(callback) {
env.getTemplate("partials/components/intro.njk", false, "layouts/home.njk", false, function(t_14,t_13) {
if(t_14) { cb(t_14); return; }
callback(null,t_13);});
});
tasks.push(
...
output += runtime.suppressValue(env.getFilter("url").call(context, runtime.contextOrFrameLookup(context, frame, "currentUrl")), env.opts.autoescape);
